...
@ui.page('/fraude/gestion')
@plantilla
async def gestion_fraude():
    """Página de Gestión de Fraude - Próximamente"""
    ...
    with ui.column().classes('w-full h-full items-center justify-center'):
        with ui.card().classes('p-8 shadow-lg border-2 border-red-500'):
            ...
            with ui.row().classes('items-center gap-2'):
                ...
                ui.label('Gestión de Fraude').classes('text-2xl font-semibold text-red-600')
