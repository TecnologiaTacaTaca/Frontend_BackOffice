...
const Auditoria = () => {
  return (
    <Box className="w-full h-full flex items-center justify-center">
      <Card
        className="p-32 shadow-lg border-2 border-red-500"
        sx={{ minWidth: 400 }}
      >
        ...
        <Box className="flex items-center justify-center gap-2">
          <SearchIcon className="text-red-400" sx={{ fontSize: "1.5rem" }} />
          <Typography className="text-2xl font-semibold text-red-600">
            Auditoría
          </Typography>
          <FactCheckIcon className="text-red-400" sx={{ fontSize: "1.5rem" }} />
        </Box>
